...
articulos = [{articulo:"Articulo 59. Sanciones.",subtotal:0,subpuntuacion:0,color:"danger",madurez:0,colorm:"danger",descripcion:" las entidades de intermediación financiera, administradores y participantes del SIPARD, entidades públicas de intermediación financiera y las entidades de apoyo y servicios conexos, deben establecer acciones para el desarrollo, implementación y mantenimiento del programa de seguridad cibernética y de la información.",vermas:"Ver mas..",recomendaciones:""},
            {articulo:"Articulo 60 Medidas Precautorias",subtotal:0,subpuntuacion:0,color:"danger",progres:0,madurez:0,colorm:"danger",descripcion:"las entidades de intermediación financiera, administradores y participantes, deben contar con una estructura gerencial y funciones de control de seguridad cibernética y de la información, acordes a su naturaleza, tamaño, complejidad, perfil de riesgo e importancia sistémica.",vermas:"Ver mas..",recomendaciones:""},
            ];
...
preguntas = [[{pregunta :"¿Verificar que el reglamento aplique las sanciones a quienes  inflijan sus normas?",indice:1,validacion:false,color:"danger",currentRate:0,progres:0,recomendaciones:["hola1.1","hola2.1","hola3.1"]},
              {pregunta:"¿Verificar que los instructivos creados puedan ser aplicados a la ley monetaria y finaciera?",indice:2,validacion:false,color:"danger",currentRate:0,progres:0,recomendaciones:["hola1.2","hola2.2","hola3.2"]},
                  ],[
              {pregunta:"¿Verificar que que las entidades de apoyo y servicios conexos mantenga la interconexion o intercambio de información reciban una sansión en caso de incumplir con lo anterior.?",indice:3,validacion:false,color:"danger",currentRate:0,progres:0,recomendaciones:["hola1","hola2","hola3"]},
                    {pregunta:" ¿Verificar como medida precautoria, el Banco Central suspenda temporalmente a los porticipantes de SIPARD que incumplan con el relgamento para disminuir el riesgo.?",indice:4,validacion:false,color:"danger",currentRate:0,progres:0,recomendaciones:["hola1","hola2","hola3"]},
                   ] ]
